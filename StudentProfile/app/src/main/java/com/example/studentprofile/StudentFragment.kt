    ...
    fun init(v1: ViewGroup?) {
        ...
        btn_login.setOnClickListener {
            if (id.text != null && pass.text != null) {
                ...
                val file = File(fileDir, "Student.txt")
                val seperator = "\n"
                if (file.exists()) {
                                ...
                                if (arrayData[j] == pass.text.toString() && j == i + 1) {
                                    ...
                                    if(fileStudent.exists() && fileStudentProfile.exists()) {
                                        ...
                                        if(flg_open == true) {
                                            ...
                                            val intent = Intent(requireContext(), StudentRegistrationForm::class.java)
        ...
        btn_registerHere.setOnClickListener {
            val dialogView = layoutInflater.inflate(R.layout.register_student, null)
                    ...
                    for (i in arrayData2.indices) {
                        if (arrayData2[i].trim() == Id.text.toString()) {
                            ...
                            if (Id == newId) {
                                Toast.makeText(
                                    requireContext(),
                                    newId.text.toString() + " is already a student",
                                    Toast.LENGTH_SHORT
                                )
                                    .show()
                                flg = true
            ...
            builder.setTitle("Adding new-Student")
            builder.setMessage("Please enter data carefully")
